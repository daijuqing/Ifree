...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [ShareSDK connectSinaWeiboWithAppKey:KsinaWeiboAppKey appSecret:KsinaWeiboAppSecret redirectUri:KredirectUri];
    
    [ShareSDK connectTencentWeiboWithAppKey:KTXAPPID appSecret:KTXAPPKEY redirectUri:KredirectUri];
...
- (void)loadViewControllers{
    ...
    NSArray *storys = @[@"CouponStoryboard",@"SortStoryboard",@"RushStoryboard",@"CenterStoryboard"];
    
    NSMutableArray *navs = [[NSMutableArray alloc]init];
    
    int i = 0;
    for (NSString *storyName in storys) {
        
        UIStoryboard *stroy = [UIStoryboard storyboardWithName:storyName bundle:nil];
        UINavigationController *nav = [stroy instantiateInitialViewController];
        
        UIImage *image = [UIImage imageNamed:[NSString stringWithFormat:@"tab_%d_unselect",i]];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "daidaidai.___" in the application's documents directory.
