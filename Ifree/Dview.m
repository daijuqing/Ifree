...
//        [button setTitleColor:[UIColor colorWithRed:53/255.f green:186/255.f blue:178/255.f alpha:1] forState:UIControlStateHighlighted];
    ...
    UIView *view = [[UIView alloc]initWithFrame:CGRectMake(0, TopScHeight - LineHeght - line_jian + 2, _topScroll.contentSize.width, 1)];
    view.backgroundColor = [UIColor lightGrayColor];
    [_topScroll addSubview:view];
    ...
    _bottomScroll = [[UIScrollView alloc] initWithFrame:CGRectMake(0, statusBar+TopScHeight - topTObottomSpace, ScreenWidth, BottomScHeight)];
...
//    }
    ...
    UIButton *btn = (UIButton *)[_topScroll viewWithTag:200];
    [self btnClick:btn];
}
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
    ...
    UIButton *btn = (UIButton *)[_topScroll viewWithTag: 200+index];
    [self btnClick:btn];
    _FinalPage = (NSInteger)scrollView.contentOffset.x/ScreenWidth;
    [self changeTop];
